...
public class TesteProva1Resumido {
	...
	public void testeCadastroUsuario() {
		...
		Banda artista2 = new Banda("JoseSoares", "Jose Soares", "contato@js.com", "jj90");
		ArrayList<Banda> bandas = new ArrayList<Banda>();
		bandas.add(artista2);
		Usuario banda = new Banda("ForroBoys", "Forro Boys", "contato@fb.com", "forrozinho", bandas);
	...
	public void testePesquisarPorData() throws ValorInvalido, UsuarioJaCadastrado, EstiloJaCadastrado, UsuarioNaoCadastrado, MusicaJaCadastrada, EstiloNaoCadastrado {
		...
		Usuario artista1 = new Banda("zeca", "Zeca Baleiro", "zecabaleiro@mail.com", "z3qu1nh4");
		Usuario artista2 = new Banda("alceu", "Alceu Valenca", "alceu@mail.com", "seualceu");
